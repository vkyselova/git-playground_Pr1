...
def if_candidate_repeated(candidate):
    if candidate in guess_list:
        return True
...
while not is_game_over():
    ...
    if if_candidate_repeated(guess):
        print("You've already tried this word. Please, enter another one!")
        continue
